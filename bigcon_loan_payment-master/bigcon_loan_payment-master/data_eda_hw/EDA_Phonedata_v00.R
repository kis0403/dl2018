...
# 데이터 파일 불러오기
train_data = read.csv('/home/snu/Bigcontest/challenge_data/Data_set.csv',fileEncoding='euc-kr',stringsAsFactors = FALSE)
...
# 해당 data set
Phone_data = train_data[,Phone_and_user_idx]
...
Phone_data_discrete <- Phone_data[,discrete_idx]
Phone_data_continous <-  Phone_data[,-c(discrete_idx,1,2,3,4,5)]
